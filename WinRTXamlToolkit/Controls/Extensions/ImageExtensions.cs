...
namespace WinRTXamlToolkit.Controls.Extensions
{
    public static class ImageExtensions
    {
        ...
        {
            bool oldFadeInOnLoaded = (bool)e.OldValue;
...
#pragma warning restore 4014
        ...
        private static void OnSourceChanged(
            DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            object oldSource = (object)e.OldValue;
            object newSource = (object)d.GetValue(SourceProperty);
        ...
        private static async void OnCustomSourceChanged(
            DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            string oldCustomSource = (string)e.OldValue;
    ...
    public class FadeInOnLoadedHandler
    {
        ...
        private void OnSourceImageOpened(object sender, RoutedEventArgs e)
        {
            ...
            //_image.Opacity = 0;
#pragma warning disable 4014
            _image.FadeInCustom(TimeSpan.FromSeconds(1));
#pragma warning restore 4014
        }
