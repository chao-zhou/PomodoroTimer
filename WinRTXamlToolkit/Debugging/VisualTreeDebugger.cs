...
namespace WinRTXamlToolkit.Debugging
{
    ...
    public class VisualTreeDebugger
    {
        ...
        private static void BreakOnControlLoaded(object sender, RoutedEventArgs e)
        {
        ...
        private static void BreakOnControlTapped(object sender, TappedRoutedEventArgs e)
        {
            var startElement = (DependencyObject)sender;
            DebugVisualTree(startElement);
        }
        ...
        /// The <see cref="System.Windows.Input.GestureEventArgs"/> instance
        /// containing the event data.</param>
        private static void BreakOnControlLayoutUpdated(object sender, object e)
        {
            var startElement = (DependencyObject)sender;
            DebugVisualTree(startElement);
        }
